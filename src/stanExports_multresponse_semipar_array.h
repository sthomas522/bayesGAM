...
namespace model_multresponse_semipar_array_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_multresponse_semipar_array");
    reader.add_event(178, 176, "end", "model_multresponse_semipar_array");
    return reader;
}
#include <stan_meta_header.hpp>
class model_multresponse_semipar_array
  : public stan::model::model_base_crtp<model_multresponse_semipar_array> {
private:
        int N;
        int p;
        int q;
...
public:
    model_multresponse_semipar_array(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_multresponse_semipar_array_namespace::model_multresponse_semipar_array";
    ...
    ~model_multresponse_semipar_array() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_multresponse_semipar_array_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_multresponse_semipar_array";
    }
...
typedef model_multresponse_semipar_array_namespace::model_multresponse_semipar_array stan_model;
#ifndef USING_R
