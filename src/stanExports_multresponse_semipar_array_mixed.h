...
namespace model_multresponse_semipar_array_mixed_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_multresponse_semipar_array_mixed");
    reader.add_event(242, 240, "end", "model_multresponse_semipar_array_mixed");
    return reader;
}
#include <stan_meta_header.hpp>
class model_multresponse_semipar_array_mixed
  : public stan::model::model_base_crtp<model_multresponse_semipar_array_mixed> {
private:
        int N;
        int p;
        int q;
...
public:
    model_multresponse_semipar_array_mixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_multresponse_semipar_array_mixed_namespace::model_multresponse_semipar_array_mixed";
    ...
    ~model_multresponse_semipar_array_mixed() { }
            ...
            if (as_bool(logical_eq(famnum, 1))) {
                ...
                for (int j1 = 1; j1 <= r; ++j1) {
                    ...
                    for (int k1 = 1; k1 <= q; ++k1) {
                        ...
                        } else if (as_bool(logical_eq(get_base1(lambdanum, k1, "lambdanum", 1), 2))) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_multresponse_semipar_array_mixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_multresponse_semipar_array_mixed";
    }
...
typedef model_multresponse_semipar_array_mixed_namespace::model_multresponse_semipar_array_mixed stan_model;
#ifndef USING_R
