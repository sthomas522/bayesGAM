...
#include "stanExports_multresponse_semipar_array_discrete.h"

RCPP_MODULE(stan_fit4multresponse_semipar_array_discrete_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_multresponse_semipar_array_discrete")
