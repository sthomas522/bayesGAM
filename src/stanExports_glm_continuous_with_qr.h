...
namespace model_glm_continuous_with_qr_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_continuous_with_qr");
    reader.add_event(132, 130, "end", "model_glm_continuous_with_qr");
    return reader;
}
#include <stan_meta_header.hpp>
class model_glm_continuous_with_qr
  : public stan::model::model_base_crtp<model_glm_continuous_with_qr> {
private:
        int N;
        int p;
        int r;
...
public:
    model_glm_continuous_with_qr(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_continuous_with_qr_namespace::model_glm_continuous_with_qr";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_continuous_with_qr_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_glm_continuous_with_qr";
    }
...
typedef model_glm_continuous_with_qr_namespace::model_glm_continuous_with_qr stan_model;
#ifndef USING_R
