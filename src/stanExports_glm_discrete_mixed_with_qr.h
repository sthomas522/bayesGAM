...
namespace model_glm_discrete_mixed_with_qr_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_discrete_mixed_with_qr");
    reader.add_event(245, 243, "end", "model_glm_discrete_mixed_with_qr");
    return reader;
}
#include <stan_meta_header.hpp>
class model_glm_discrete_mixed_with_qr
  : public stan::model::model_base_crtp<model_glm_discrete_mixed_with_qr> {
private:
        int N;
        int p;
        int q;
...
public:
    model_glm_discrete_mixed_with_qr(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_discrete_mixed_with_qr_namespace::model_glm_discrete_mixed_with_qr";
        ...
        try {
            ...
            validate_non_negative_index("lambdanum", "(q + 1)", (q + 1));
            context__.validate_dims("data initialization", "lambdanum", "int", context__.to_vec((q + 1)));
            lambdanum = std::vector<int>((q + 1), int(0));
            vals_i__ = context__.vals_i("lambdanum");
            pos__ = 0;
            size_t lambdanum_k_0_max__ = (q + 1);
            ...
            validate_non_negative_index("lambda_param", "q", q);
            validate_non_negative_index("lambda_param", "lambda_max_params", lambda_max_params);
            context__.validate_dims("data initialization", "lambda_param", "matrix_d", context__.to_vec(q,lambda_max_params));
            lambda_param = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(q, lambda_max_params);
            vals_r__ = context__.vals_r("lambda_param");
            pos__ = 0;
            size_t lambda_param_j_2_max__ = lambda_max_params;
            size_t lambda_param_j_1_max__ = q;
    ...
    ~model_glm_discrete_mixed_with_qr() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_discrete_mixed_with_qr_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_glm_discrete_mixed_with_qr";
    }
...
typedef model_glm_discrete_mixed_with_qr_namespace::model_glm_discrete_mixed_with_qr stan_model;
#ifndef USING_R
