...
#include "stanExports_glm_continuous_with_qr.h"

RCPP_MODULE(stan_fit4glm_continuous_with_qr_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_glm_continuous_with_qr")
